...
class Rol extends CActiveRecord
{
	...
	public static function model($className=__CLASS__)
	{
        ...
        {
            return CHtml::ListData(self::model()->findAllBySql("SELECT id, (LEFT(UPPER(name_rol),1) || RIGHT(LOWER(name_rol),CHAR_LENGTH(name_rol)-1)) as name_rol FROM rol"),'id','name_rol');
        } 
}
