...
class LoginForm extends CFormModel
{
	...
	public function authenticate($attribute,$params)
	{
        ...
        public function authenticateAutoLogin($user)
	{
	...
	public function login()
	{
        ...
        public function loginAutoLogin($user)
	{                
		if($user!=null && $this->_identity===null)
		{
                    $this->_identity=new UserIdentity($user->username,$user->password);
                    $this->_identity->authenticateAutoLogin();
                        
                       
		}
                
		if($user!=null && $this->_identity->errorCode===UserIdentity::ERROR_NONE)
		{
			$duration=$this->rememberMe ? 3600*24*30 : 0; // 30 days
			Yii::app()->user->login($this->_identity,$duration);
			return true;
